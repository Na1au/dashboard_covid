<template>
  <div class="home">
    <Topwrapper title="Dashboard de dados da COVID-19" />
    <div class="overall">
      <h3 class="overall_cases"><ICountUp :endVal="parseInt(totalcases)" /></h3>
      <h5 class="overall_cases_title">Total de casos</h5>
      <div class="field">
        ...
        <div class="tile is-ancestor">
          <div class="tile is-parent">
            <div class="tile is-child box">
              <div class="content">
                <p class="title">Países afetados</p>
                <p class="subtitle">
          ...
          <div class="tile is-6 is-vertical is-parent">
            <div class="tile is-child box">
              <p class="title">Registros em 30 dias</p>
              <p class="subtitle">
                (Dados atualizados a cada 10 minutos)
              </p>
              <div class="content">
